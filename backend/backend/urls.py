...
from api.views import login, loan_simulator, Home, loan_status, BankLogin, loan_status_funcionarios, decision, escolher_horario
...
urlpatterns = [
    ...
    path('escolher_horario/', escolher_horario, name='escolher_horario'),
